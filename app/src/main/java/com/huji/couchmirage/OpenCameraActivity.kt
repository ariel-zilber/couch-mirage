...
class OpenCameraActivity : AppCompatActivity() {
    ...
    val CUBE_RENDABLE_COLOR = Color(255F, 255F, 255F)
    ...
    // co
    private var MAX_FLOOR_ANCHORS = 3
    ...
    private fun setSeekBar() {
        ...
        seekBar.onSeekChangeListener = (object : SeekBar.OnSeekBarChangeListener,
            ...
            override fun onSeeking(seekParams: SeekParams?) {
                box.setHeight(seekParams!!.progress.toFloat())
...
//                TODO("Not yet implemented")
    ...
    private fun setBottomPanel() {
        ...
        val measurement: View = findViewById(R.id.fab_measurement)
